    ...
    def save(self, **kwargs):
        try:
            ...
            try:
                ...
                return outstanding_token.delete()
...
class GetRoomSerializer(serializers.ModelSerializer):
    total_device_count = serializers.SerializerMethodField()

    class Meta:
        model = Room
        fields = '__all__'
    def get_total_device_count(self, obj):
        print(obj)
        return Device.objects.filter(room=obj).count()
